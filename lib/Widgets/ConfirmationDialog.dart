...
class ConfirmationDialog extends StatelessWidget {
  ...
  ConfirmationDialog({super.key, required this.msg,required this.yesCB, required this.noCB});
  ...
  Widget build(BuildContext context) {
    return DialogContainer(dialogContent: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [Expanded(
                  child: _YesNoButton('Yes',yesCB,const Color.fromARGB(255, 142, 248, 145)),
                ),Expanded(
                  child: _YesNoButton('No',noCB, const Color.fromARGB(255, 252, 138, 130)),
                )],)
