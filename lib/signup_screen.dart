...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  TextEditingController _emailTextEditingController = TextEditingController(), _passwordTextEditingController = TextEditingController(),_cfmPasswordTextEditingController = TextEditingController();
  FocusNode _emailFocus = FocusNode(), _passwordFocus = FocusNode(), _cfmPasswordFocus = FocusNode();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar:   Container(
        ...
        child: FilledButton(onPressed: checkCredentialsAndRegister, child: const Text('Register',style: TextStyle(color: Colors.black),),style: ButtonStyle(shape: WidgetStatePropertyAll(RoundedRectangleBorder( borderRadius: BorderRadius.circular(10) )), backgroundColor: const WidgetStatePropertyAll(Colors.white)))),
      ...
      body: SafeArea(child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            txtField(_cfmPasswordFocus, _cfmPasswordTextEditingController, 'Confirm Password',isEmail: false),
          ],
        ),
      )),
    );
  ...
  checkCredentialsAndRegister()
  {
    ...
    else if(_passwordTextEditingController.text != _cfmPasswordTextEditingController.text)
    {
